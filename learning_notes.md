...
for property field use TObjectPtr. Useful for automatic replacement of raw pointers to support advanced cook-time dependency tracking and editor-time lazy load use case (wtf?)\
...
USE_CHECKS_IN_SHIPPING - enable all except *Slow*. default 0\
